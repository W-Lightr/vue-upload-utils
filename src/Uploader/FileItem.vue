...
const props = defineProps({
  upload:{
    type: Object as PropType<UploaderObject>,
    required: true,
  },
  taskItem:{
...
const iconUrl = getIcon(fileSuffix)
...
<template>
  <div class="flex items-center justify-between p-2 border rounded-lg">
    <div style="flex: 6" class="flex items-center">
      <img :src="iconUrl" :alt="`icon for ${fileSuffix}`" class="file-icon" />
      <div class=" w-10/12">
    ...
    <div style="flex: 2" class="flex items-center space-x-2">
      ...
      <div class="w-full flex items-center mr-2 text-xl">
